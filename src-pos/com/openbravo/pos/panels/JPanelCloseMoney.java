...
import com.openbravo.pos.panels.PaymentsModel.ProductSalesLine;
import com.openbravo.pos.panels.PaymentsModel.ProductSalesLineR;
import com.openbravo.pos.panels.PaymentsModel.Stock;
        ...
        if (res == JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                try {
                    ...
                    message.setRecipients(Message.RecipientType.TO,InternetAddress.parse(config.getProperty("correoReceptor1")));
                    //message.setRecipients(Message.RecipientType.TO,InternetAddress.parse("csandoval@toka.com.mx"));
                    message.setSubject("Cierre de caja "+config.getProperty("machine.hostname")  +". Fecha: "+Formats.TIMESTAMP.formatValue(dNow));
                    String body
                            = "<html><table><tr><td colspan=\"8\">*REPORTE DE CIERRE DE CAJA. SUCURSAL: " +config.getProperty("machine.hostname")  +"</td></tr>"
                            + "<tr><td colspan=\"8\"><hr/></td></tr>"
                            + "<tr><td colspan=\"4\">Secuencia:</td><td colspan=\"4\">" + m_PaymentsToClose.printSequence() + "</td></tr>"
                            + "<tr><td colspan=\"4\">Fecha de inicio:</td><td colspan=\"4\">" + m_PaymentsToClose.printDateStart() + "</td></tr>"
                            + "<tr><td colspan=\"4\">Fecha de fin:</td><td colspan=\"4\">" + Formats.TIMESTAMP.formatValue(dNow) + "</td></tr>"
                            + "<tr><td colspan=\"4\">Tickets expedidos:</td><td colspan=\"4\">" + m_PaymentsToClose.printSales() + "</td></tr>"
                            + "<tr><td colspan=\"8\">&nbsp;</td></tr>"
                            + "<tr><td colspan=\"8\"><hr/></td></tr><tr></tr>"
                            + "<tr><td colspan=\"8\">*REPORTE DE PAGOS.</td></tr>"
                            + "<tr><td colspan=\"8\"><hr/></td></tr>"
                            + "<tr><td colspan=\"4\">Forma de pago</td><td colspan=\"4\">Monto</td></tr>";
                    java.util.List<PaymentsModel.PaymentsLine> payments = m_PaymentsToClose.getPaymentLines();
                    for (int i = 0; i < payments.size(); i++) {
                        body += "<tr><td colspan=\"4\">" + payments.get(i).printType() + "</td><td colspan=\"4\">" + payments.get(i).printValue() + "</td></tr>";
                    }
                    body += "<tr><td colspan=\"8\">&nbsp;</td></tr>"
                    + "<tr><td colspan=\"8\"><hr/></td></tr><tr></tr>"       
                            + "<tr><td colspan=\"8\">*REPORTE DE VENTAS.</td></tr>"
                            + "<tr><td colspan=\"8\"><hr/></td></tr>"
                            + "<tr><td colspan=\"2\">Producto</td><td>Presentacion</td><td>Envase</td><td>Cant</td><td>P. Compra</td><td>Total</td><td>Ganancia</td></tr>";
                    java.util.List<ProductSalesLine> productSales = m_PaymentsToClose.getProductSalesLines();
                    for (int i = 0; i < productSales.size(); i++) {
                        body += "<tr><td colspan=\"2\">" + productSales.get(i).printProductName() + "</td><td>" + productSales.get(i).printPresentacion()+ "</td><td>" + productSales.get(i).printEnvase()+ "</td><td>X" + productSales.get(i).getProductUnits() + "</td><td>" + productSales.get(i).printPriceBuy()+ "</td><td>" + productSales.get(i).printTotal() + "</td></tr>";
                    }
                    body += "<tr><td colspan=\"8\">&nbsp;</td></tr>"
                    + "<tr><td colspan=\"8\"><hr/></td></tr><tr></tr>"
                            + "<tr><td colspan=\"8\">*REPORTE DETALLADO.</td></tr>"
                            + "<tr><td colspan=\"8\"><hr/></td></tr>"
                            + "<tr><td colspan=\"2\">Producto</td><td>Presentacion</td><td>Envase</td><td>Cant</td><td>Persona</td><td>Num Ticket</td></tr>";
                    java.util.List<ProductSalesLineR> productSalesR = m_PaymentsToClose.getProductSalesLinesR();
                    for (int i = 0; i < productSalesR.size(); i++) {
                    ...
                    body += "<tr><td colspan=\"8\">&nbsp;</td></tr>"
                         + "<tr><td colspan=\"8\"><hr/></td></tr><tr></tr>"
                            ...
                            + "<tr><td colspan=\"8\"><hr/></td></tr>"
                            + "<tr><td colspan=\"4\">Producto</td><td colspan=\"4\">Unidades</td></tr>";
                    java.util.List<Stock> stock = m_PaymentsToClose.getStockLines();
                    for (int i = 0; i < stock.size(); i++) {
                        body += "<tr><td colspan=\"4\">" + stock.get(i).printProductName() + "</td><td colspan=\"4\">" + stock.get(i).printUnits().toString() + "</td></tr>";
                    }
