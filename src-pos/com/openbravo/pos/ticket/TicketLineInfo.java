...
*/
    ...
    public TicketLineInfo(ProductInfoExt product, double dMultiply, double dPrice, TaxInfo tax, Properties attributes,String tipo, String envase, double precioCompra) {
        ...
        init(pid, null, dMultiply, dPrice, tax, attributes,tipo, envase,precioCompra);
    }
/*
    ...
    public void writeValues(DataWrite dp) throws BasicException {
        ...
        dp.setString(9, tipo);
        dp.setString(10, envase);
        dp.setDouble(11, new Double(precioCompra));
    }
    ...
    public void readValues(DataRead dr) throws BasicException {
        ...
        tipo=dr.getString(17);
        envase=dr.getString(18);
        precioCompra = dr.getDouble(19);
    }
    ...
    public String printTipo() {
        return StringUtils.encodeXML(tipo);
    }
    public String printEnvase() {
        return StringUtils.encodeXML(envase);
    }
