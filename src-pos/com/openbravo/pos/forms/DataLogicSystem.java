...
public class DataLogicSystem extends BeanFactoryDataSingle {
    ...
    public void init(Session s){
        ...
        m_activecash2 = new PreparedSentence(s
            , "SELECT HOSTSEQUENCE FROM CLOSEDCASH WHERE DATEEND IS NOT NULL AND E <> 1 ORDER BY HOSTSEQUENCE"
            , null
            , cortes);
         m_activecash3 = new PreparedSentence(s
            , "SELECT HOSTSEQUENCE FROM CLOSEDCASH WHERE DATEEND IS NOT NULL ORDER BY HOSTSEQUENCE DESC"
            , null
            , cortes);
        ...
        m_closedcashupdate = new StaticSentence(s
                , "UPDATE CLOSEDCASH SET E = ? WHERE HOSTSEQUENCE = ?"
...
//    public abstract BaseSentence getShutdown();
    ...
    public final List findCortes() throws BasicException {
        return m_activecash2.list();
    }   
    public final List findCortes2() throws BasicException {
        return m_activecash3.list();
    }
    ...
    public final void execClosedCashUpdate (Object[] userdata) throws BasicException {
        m_closedcashupdate.exec(userdata);
    }
