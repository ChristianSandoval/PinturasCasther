...
public class JTicketCatalogLines2 extends javax.swing.JPanel {
    
    private JRefundLines2 m_reflines;
    private CatalogSelector m_catalog;
    
    /** Creates new form JTicketCatalogLines */
    public JTicketCatalogLines2(AppView app, JPanelTicketEdits2 jTicketEdit, boolean pricevisible, boolean taxesincluded, int width, int height) {
        ...
        m_reflines = new JRefundLines2(dlSystem, jTicketEdit);        
